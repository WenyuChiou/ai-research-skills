...
|---|---|---|
| `pipeline-overview.png` | Top of [`README.md`](../../README.md) | Vertical infographic, 1024×1500, 8-stage research pipeline + 14 skills + cross-cutting tools band. (Regenerate when the skill count changes; the current PNG may still show an older count until regen.) |
...
- Soft blue / white background, single teal accent (#2DA89C). No orange, no warning colors, no "human-owned" or "gap" annotations — every stage gets the same color treatment.
