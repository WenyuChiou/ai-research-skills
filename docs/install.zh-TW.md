...
主 README 跟 [README.zh-TW.md](../README.zh-TW.md) 已經把 6 個 plugin 的
...
裝好之後 6 個 plugin 全部到位(14 個核心 skill + audit-first-skills 的
5 個 skill)。Step 5(research-hub CLI)跟 step 3-4(Zotero / Codex /
Gemini 外部 binary)的前置設定看
README。
